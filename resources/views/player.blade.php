        ...
        <div class="col-md-7">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <img src="{{asset('/emblems/Emblem_'.ucfirst($flexStat->tier).'.png')}}" style="width:65px" alt="">
                    {{$flexStat->tier}}
                    {{$flexStat->rank}}
                    <hr>
                ...
                <div class="col-md-6">
                    ...
                    <img src="{{asset('/emblems/Emblem_'.ucfirst($soloStat->tier).'.png')}}" style="width:65px" alt="">
                    {{$soloStat->tier}}
                    {{$soloStat->rank}}
                    <hr>
                    <div class="card text-white bg-dark mb-3" style="max-width: 18rem;">
